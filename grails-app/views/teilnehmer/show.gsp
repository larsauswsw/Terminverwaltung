...
<html>
    ...
    <body>
        ...
        <div id="show-teilnehmer" class="content scaffold-show" role="main">
            ...
            <f:display bean="teilnehmer" />
            <g:form resource="${this.teilnehmer}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.teilnehmer}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
