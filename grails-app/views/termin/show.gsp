...
<html>
    ...
    <body>
        ...
        <div id="show-termin" class="content scaffold-show" role="main">
            ...
            <f:display bean="termin" />
            <g:form resource="${this.termin}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.termin}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
